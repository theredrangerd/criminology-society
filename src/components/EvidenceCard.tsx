...
export const EvidenceCard: React.FC<EvidenceCardProps> = ({
  ...
  // Smooth springs for 3D physics (subtle tactile tilt without projecting past container)
  ...
  const rotateY = useSpring(useTransform(mouseX, [-0.5, 0.5], [-1.8, 1.8]), springConfig);
